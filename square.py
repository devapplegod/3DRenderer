...
class Square:
    def __init__(self, center_x, center_y, center_z, side_length, color, camera_location):
        ...
        self.nodes = [[-self.half_length, self.half_length, self.center_z], [self.half_length, self.half_length, self.center_z],
                      [-self.half_length, -self.half_length, self.center_z], [self.half_length, -self.half_length, self.center_z]]
    ...
    def draw(self):
        for edge in self.edges:
            ...
            self.__line(x1 + self.center_x, y1 + self.center_y, x2 + self.center_x, y2 + self.center_y)
